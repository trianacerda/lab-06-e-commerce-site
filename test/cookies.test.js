...
test('test renderCookies', (expect) => {
    ...
    const expected = `<li><h3>cowboy</h3><img src="./assets/cowboy.jpeg" alt="cowboy"><span>$4</span><button class="add" value="cowboy">Add to Jar</button><span>mixture of everything but the sink</span><select><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></li>`;
